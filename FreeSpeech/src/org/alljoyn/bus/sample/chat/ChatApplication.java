...
public class ChatApplication extends Application implements Observable {
	 ...
	 * can't do anything wihtout a bus attachment. When the service comes up it
	...
	public synchronized void hostSetChannelState(
			AllJoynService.HostChannelState state) {
	...
	public synchronized void useSetChannelState(
			AllJoynService.UseChannelState state) {
